...
The above mentioned file has been downloaded and stored in `/app/data/external` folder. User can choose to use the same file for the subsequent steps, in which case 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTI3ODAzMzc1LDU4ODMwMzMzNSwtMTA4Mj
