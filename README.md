...
docker run -e AWS_ACCESS_KEY_ID=AKIAIQ3UKVOUETYP2FYQ -e AWS_SECRET_ACCESS_KEY=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 got_image src/write_to_s3.py
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAyODI0MDE2LDE1MjU1OTU1MywtMjM5NT
