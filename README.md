...
- [Project Backlog](#directory-structure)
...
### Epics and Stories
The initiatives defined above are broken down into major milestones (epics) which are further split into distinct pieces of work (stories). Stories are listed in descending order of priority or order of execution. Each story is assigned points according to expected magnitude of work (0 - 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjI1NTEwMzA1LC0xMzczNzE4MzUsLTEyOD
I4OTgwMjUsNDk3Mjg3NjkyLC0yOTQwNDEwNzQsMTkxOTMxNzAw
Ml19
-->